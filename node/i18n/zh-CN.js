module.exports = {
    ...
    'auth.id.placeholder': '请输入用户名',
    'auth.secret.placeholder': '请输入密码',
    'auth.confirm.secret.placeholder': '请再次输入密码',
    'auth.realName.placeholder': "请输入真实姓名",
    ...
    'auth.removeAK.title': '删除用户',
    'auth.removeAK.message': '用户名：<code>{{user}}</code>, 确定删除?',

    'auth.clearAKHistories.title': '清空登录历史',
    'auth.clearAKHistories.message': '确定?',
    'auth.clearAKHistories.successMessage': '已清空登录历史',
    ...
    'deleteModal.title': '删除图片',
    'deleteModal.community.title': '删除社团',
    'community.delete.successfully': '社团删除成功',
    'deleteModal.activity.title': '删除活动',
    'activity.delete.successfully': '活动删除成功',
    ...
    'register.successfully': '注册成功，请登录',
    'register.password.notequal': '两次密码不一致，请重新输入',
    ...
    // 'username': '用户名',
    // 'password': '密码'
    'community.create': '创建社团',
    'community.create.successfully': '社团创建成功',
    'community.name': '社团名称',
    'activity.create': '创建活动',
    'activity.create.successfully': '活动创建成功',
    'activity.name': '活动名称',
    'activity.beginTime': "开始时间",
    'activity.entTime': '结束时间',
    'create.time': '创建时间',
    'desc': '备注',
    'one.select.item.only': '你只能选择一项',
    'search.similar': '找相似',
    'notimage': '不能上传非图片类型的文件',
    'begin.time.older.then.end.time': '开始时间不能大于结束时间',
    'desc.is.null': '请完善备注信息',
    'face.feature.record': '人脸特征值已经纪录',
    'no.face.detected': '未检测到人脸，请考虑是否保留该图片',
}
