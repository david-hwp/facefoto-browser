module.exports = {
    ...
    'auth.id.placeholder': 'Your Username',
    'auth.secret.placeholder': 'Your Password',
    'auth.confirm.secret.placeholder': 'Confirm Your Password',
    'auth.realName.placeholder': 'Your RealName',
    ...
    'auth.userHistories': 'User Histories',
    ...
    'auth.removeAK.title': 'Remove User',
    'auth.removeAK.message': 'Remove User：<code>{{user}}</code>, Are you sure?',

    'auth.clearAKHistories.title': 'Clear User Histories',
    'auth.clearAKHistories.message': 'Are you sure?',
    'auth.clearAKHistories.successMessage': 'All User Histories has been clear',
    ...
    'deleteModal.title': 'Delete These Photos',
    'deleteModal.community.title': 'Delete These Communities',
    'community.delete.successfully': 'Delete Community Successfully',
    'deleteModal.activity.title': 'Delete These Activities',
    'activity.delete.successfully': 'Delete Activity Successfully',
    ...
    'register.successfully': 'Register successful，please login',
    'register.password.notequal': 'Password was not equal, please try again',
    ...
    'community.create.successfully': 'Community Create Successfully',
    'community.name': 'Name Of Community',
    'activity.create': 'Create Activity',
    'activity.create.successfully': 'Activity Create Successfully',
    'activity.name': 'Name Of Activity',
    'activity.beginTime': "Start Time",
    'activity.entTime': 'End Time',
    'create.time': 'Create At',
    'desc': 'Description',
    'one.select.item.only': 'You Must Select Only One Item',
    'search.similar': 'Search The Similar',
    'notimage': 'You can only upload pictures',
    'begin.time.older.then.end.time': 'BeginTime Old Then EndTime',
    'desc.is.null': 'Description Cant Be Empty',
    'face.feature.record': 'Face Feature Recorded',
