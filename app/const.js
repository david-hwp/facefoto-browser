angular.module('web')
    .factory('Const', [function () {
        ...
        function getStorageClasses(f) {
            ...
            switch (f) {
                case 3:
                    return storageClasses.concat([{value: 'Archive', name: '归档类型'}]); //归档类型
                case 2:
        ...
        return {
            ...
            SHOW_HIS: 'show-his',
            // FACEFOTO_PY_URL: 'http://127.0.0.1:5000',
            FACEFOTO_PY_URL: 'http://47.75.48.7:8080',
            USER_MANAGER_URL: 'http://47.75.62.101:7000/api',

            OSS_ACCESS_KEY_ID: 'LTAIwlhrcuPLLwB9',
            OSS_ACCESS_KEY_SECRET: 'pQno11f1GC4fpP8lEb3H8nCJjq5uTs',
            OSS_DEFAULT_PATH:'oss://facefoto-test/',
